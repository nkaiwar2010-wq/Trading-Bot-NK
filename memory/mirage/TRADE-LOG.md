...
<!-- DAEMON_ENTRY: CIGL long 2026-08-03 -->
### Aug 03 15:54 UTC — Intraday Daemon Entry
**CIGL** long 14162 sh @ ~$0.54 (actual fill) | stop $0.52 | target $0.57 (2.0:1) | gap -17.1%, ORB confirmed above $0.56 | Rule 1: 14162 x $0.02 = $227.89 (0.5% of $43,332 equity, cap 4%)
...
<!-- DAEMON_ENTRY: DDD long 2026-08-04 -->
### Aug 04 13:48 UTC — Intraday Daemon Entry
**DDD** long 2492 sh @ ~$3.40 (actual fill) | stop $3.30 | target $3.60 (2.0:1) | gap 19.6%, ORB confirmed above $3.33 | Rule 1: 2492 x $0.10 = $254.18 (0.6% of $42,491 equity, cap 4%)

<!-- DAEMON_ENTRY: DORM long 2026-08-04 -->
### Aug 04 13:59 UTC — Intraday Daemon Entry
**DORM** long 49 sh @ ~$153.00 (actual fill) | stop $148.41 | target $162.18 (2.0:1) | gap 19.8%, ORB confirmed above $151.94 | Rule 1: 49 x $4.59 = $224.91 (0.5% of $42,777 equity, cap 4%)
...
<!-- DAEMON_EXIT: HYFM 2026-08-04 14:27 -->
### Aug 04 14:27 UTC — Intraday Daemon Exit (external fill)
**HYFM** closed @ ~$1.7300 | entry $1.7800 | realized P&L $-206.70 (-2.8%) | reason: stop-loss order filled (detected via position disappearance, not an explicit daemon close — P&L computed from Alpaca's fill ledger)
...
<!-- DAEMON_EXIT: ASTN 2026-08-04 14:47 -->
### Aug 04 14:47 UTC — Intraday Daemon Exit (external fill)
**ASTN** closed @ ~$4.5196 | entry $4.6600 | realized P&L $-254.01 (-3.0%) | reason: stop-loss order filled (detected via position disappearance, not an explicit daemon close — P&L computed from Alpaca's fill ledger)

<!-- DAEMON_ENTRY: CIFU long 2026-08-04 -->
### Aug 04 15:04 UTC — Intraday Daemon Entry
**CIFU** long 382 sh @ ~$21.64 (actual fill) | stop $20.99 | target $22.94 (2.0:1) | gap -16.2%, ORB confirmed above $21.55 | Rule 1: 382 x $0.65 = $247.99 (0.6% of $41,808 equity, cap 4%)

<!-- DAEMON_ENTRY: WETO long 2026-08-04 -->
### Aug 04 15:08 UTC — Intraday Daemon Entry
**WETO** long 1253 sh @ ~$5.94 (actual fill) | stop $5.76 | target $6.30 (2.0:1) | gap -17.1%, ORB confirmed above $5.49 | Rule 1: 1253 x $0.18 = $223.28 (0.5% of $41,803 equity, cap 4%)

<!-- DAEMON_EXIT: CIFU 2026-08-04 15:17 -->
### Aug 04 15:17 UTC — Intraday Daemon Exit (external fill)
**CIFU** closed @ ~$20.8300 | entry $21.6400 | realized P&L $-309.42 (-3.7%) | reason: stop-loss order filled (detected via position disappearance, not an explicit daemon close — P&L computed from Alpaca's fill ledger)

<!-- DAEMON_ENTRY: SUGP long 2026-08-04 -->
### Aug 04 16:16 UTC — Intraday Daemon Entry
**SUGP** long 17611 sh @ ~$0.40 (actual fill) | stop $0.39 | target $0.42 (2.0:1) | gap -18.5%, ORB confirmed above $0.38 | Rule 1: 17611 x $0.01 = $211.33 (0.5% of $40,656 equity, cap 4%)
